                ...
                <div class="custom-card">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="mb-4 pb-2">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $materi->judul) }}" placeholder="Maks. 100 karakter" required>
                            @error('judul')
                                <div class="invalid-feedback"><i class="bi bi-exclamation-circle-fill me-2"></i> {{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body p-4 bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jenis" id="jenis_media" class="form-select bg-white">
                                <option value="" {{ old('jenis', $media->jenis ?? '') == '' ? 'selected' : '' }}>Tidak Ada</option>
                                ...
                                <option value="video_youtube" {{ old('jenis', $media->jenis ?? '') == 'video_youtube' ? 'selected' : '' }}>Video YouTube</option>
                            </select>
                        </div>

                        <!-- Input File Lokal -->
                        <div id="input_file_container" style="display: none;" class="mt-3">
                            ...
                            <div class="p-3 bg-white border rounded-3">
                                ...
                                <div class="form-text mt-2"><i class="bi bi-info-circle me-1"></i> Biarkan kosong jika tidak diganti.</div>
                            </div>
                        </div>

                        <!-- Input URL YouTube -->
                        <div id="input_url_container" style="display: none;" class="mt-3">
                                ...
                                @if(isset($match[1]))
                                    <div class="current-file-box p-2">
                                        <div class="ratio ratio-16x9 w-100">
                                            <iframe src="https://www.youtube.com/embed/{{ $match[1] }}" class="rounded-3 border" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                @endif
                            @endif
                            ...
                            <div class="p-3 bg-white border rounded-3">
                                ...
                                <input type="text" name="video_url" id="video_url" class="form-control form-control-sm" placeholder="https://youtube.com/..." value="{{ old('video_url', $media->video_url ?? '') }}">
                            </div>
                        </div>
                    </div>
                </div>

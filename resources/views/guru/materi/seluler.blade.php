...
<div class="bg-light min-h-screen">
    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('guru.guru_master')}}">Beranda</a></li>
        ...
        <main id="materi-content">
            ...
            <div class="section-card">
                ...
                <div class="visual-container">
                    ...
                    <p style="color: #718096; margin-top: 1rem; font-size: 0.9rem;">
                        [Ilustrasi Microwave Signal Transmission] Data "terbang" dari tower ke tower dengan kecepatan cahaya!
                    </p>
                </div>
            ...
            <div class="section-card">
                ...
                <div class="simple-explanation">
                    <h6><i class="bi bi-question-circle"></i> VSAT IP</h6>
                    <p style="margin: 0;">
                ...
                <div class="visual-container">
                    ...
                    <p style="color: #718096; margin-top: 1rem; font-size: 0.9rem;">
                        [Ilustrasi Satellite Communication] Satelit di luar angkasa "ngobrol" dengan antena parabola di Bumi
                    </p>
                </div>
            ...
            <section id="quiz-section" class="mb-5">
                <div class="quiz-card">
                    ...
                    <div id="quiz-container">
                        ...
                        <a href="{{ route('guru.materi.optik', ['id' => 5]) }}" id="nextMaterialBtn" class="btn btn-success w-100 mt-3 d-none fw-bold">Lanjut ke Materi Berikutnya <i class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </section>
        </main>

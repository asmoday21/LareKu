...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .filter-select:focus { border-color: var(--color-brand); box-shadow: 0 0 0 4px rgba(5, 150, 105, 0.1); outline: none; }

        .btn-add-materi { background: linear-gradient(135deg, var(--color-brand), var(--color-brand-dark)); border: none; padding: 0.6rem 1.5rem; border-radius: 50px; font-weight: 700; color: white; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 0.5rem; }

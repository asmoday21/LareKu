...
<style>
    /* Konsistensi dengan Halaman Edit */
    :root {
        --warm-primary: #D97706;
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="fw-bold mb-0" style="font-size:20px; color: #111827;">Tambah Video</h2>
                <p class="mb-0 text-muted" style="font-size:13px;">Tambahkan materi video baru untuk siswa</p>
            </div>
        </div>
                    ...
                    <form action="{{ route('guru.video.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea 
                                ...
                                class="form-control" 
                                rows="4" 
                                placeholder="Tuliskan penjelasan singkat mengenai isi video..."></textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn-save">
                                <i class="fas fa-check-circle me-2"></i> Tambah Video
                            </button>
                        </div>

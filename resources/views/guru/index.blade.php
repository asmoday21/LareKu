    ...
    <div class="container mx-auto py-6 px-4 sm:px-6 lg:px-8 flex-grow max-w-7xl">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center p-6 md:p-8 gap-4">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start gap-5 w-full md:w-auto">
                    ...
                    <div class="relative">
                        <div class="w-20 h-20 rounded-full border-4 border-white/30 shadow-xl overflow-hidden bg-gradient-to-br from-blue-200 to-purple-200">
                            <img src="{{ !empty(Auth::user()->profile_image) ? url('upload/guru_images/' . Auth::user()->profile_image) : url('upload/admin_images.jpg') }}" 
                                 onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name='+encodeURIComponent('{{ Auth::user()->name ?? 'Guru' }}')+'&background=1a56db&color=fff&size=100';"
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <h2 class="text-2xl md:text-3xl font-extrabold text-white mb-2 tracking-tight">{{ Auth::user()->name ?? 'Guru' }}! 👋</h2>
                ...
                <div class="flex flex-col items-center md:items-end gap-3 w-full md:w-auto">
                    ...
                    <p class="text-white/70 text-xs max-w-xs text-center md:text-right leading-relaxed hidden sm:block">
                        🌟 Kelola pembelajaran budaya, tradisi, dan kearifan lokal Minangkabau
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                ...
                <!-- Materi Card -->
                <a href="{{ route('guru.materi.index')}}" class="modern-card rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-6 menu-item group" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-slate-500 text-sm line-clamp-2 sm:line-clamp-none">Kelola dan tambahkan materi pembelajaran budaya Minangkabau.</p>
                    </div>
                ...
                <!-- Kearifan Lokal Card -->
                <a href="{{ route('guru.tugas.index')}}" class="modern-card rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-6 menu-item group" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-slate-500 text-sm line-clamp-2 sm:line-clamp-none">Kelola kearifan lokal dan nilai-nilai budaya Minangkabau.</p>
                    </div>
                ...
                <a href="{{ route('guru.quiz.index')}}" class="modern-card rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-6 menu-item group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-slate-500 text-sm line-clamp-2 sm:line-clamp-none">Kelola filosofi dan pepatah-petitih tradisional Minangkabau.</p>
                    </div>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="modern-card rounded-2xl p-5" data-aos="zoom-in" data-aos-delay="250">
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="font-bold text-slate-800 text-sm">Tips Mengajar</h6>
                            <p class="text-slate-500 text-xs mt-0.5">Urutan penyampaian materi yang efektif:</p>
                        </div>
                    </div>

...
<head>
    ...
    <title>Materi Pembelajaran - Tema 2 (Siswa)</title>
            ...
            <div class="col-lg-8">
                ...
                <div class="mb-5 fade-in-up delay-1">
                    <h4 class="section-title text-muted mb-4 font-inter" style="font-size: 1.25rem; border-bottom: 2px dashed var(--border-color);">
                        <i class="bi bi-collection-play me-2"></i> Materi Pengantar
                    </h4>
                ...
                <div class="content-card fade-in-up delay-2 pb-2">
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card) -->
                        @if($materiAlam && $materiAlam->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            ...
                            <div class="nested-card">
                                ...
                                {{-- Logika Penampil Media Siswa (VIEW ONLY) --}}
                                @if($item->mediaPendukung && $item->mediaPendukung->count() > 0)
                                    @php
                                        $pdfCount = $item->mediaPendukung->where('jenis', 'pdf')->count();
                                        $wordCount = $item->mediaPendukung->where('jenis', 'word')->count();
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card) -->
                        @if($materiDinamika && $materiDinamika->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="mb-2">
                            ...
                            @foreach($materiDinamika as $item)
                            <div class="nested-card">
                                <h5 class="nested-card-title"><i class="bi bi-bookmark-star"></i> {{ $item->judul }}</h5>
                                <div class="content-text text-dark prose fs-6">{!! $item->konten !!}</div>
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card) -->
                        @if($materiPembangunan && $materiPembangunan->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="mb-2">
                            ...
                            @foreach($materiPembangunan as $item)
                            <div class="nested-card">
                                <h5 class="nested-card-title"><i class="bi bi-bookmark-star"></i> {{ $item->judul }}</h5>
                                <div class="content-text text-dark prose fs-6">{!! $item->konten !!}</div>

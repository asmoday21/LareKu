...
<head>
    ...
    <title>Materi Pembelajaran - Tema 4 (Siswa)</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 767.98px) { .header-content h1 { font-size: 1.75rem; } .topic-block { padding: 1rem; } .sidebar-widget { padding: 1.25rem; } }
    ...
    <div class="app-container">
        ...
        <div class="row g-4 g-lg-5 mt-2">
            ...
            <div class="col-lg-8">
                ...
                <div class="mb-5 fade-in-up delay-1">
                                            ...
                                            <div id="preview{{ $media->id }}" class="collapse mt-3 w-100 border-top pt-3">
                                                ...
                                                @elseif($media->jenis == 'word')
                                                    ...
                                                    <div class="text-center font-inter text-muted mt-2" style="font-size: 0.85rem;">
                                                        <i class="bi bi-info-circle text-primary"></i> Pratinjau Google Docs Viewer.
                                                    </div>
                                                @elseif($media->jenis == 'ppt')
                                                    ...
                                                    <div class="text-center font-inter text-muted mt-2" style="font-size: 0.85rem;">
                                                        <i class="bi bi-info-circle text-primary"></i> Pratinjau Microsoft Office Viewer.
                                                    </div>
                ...
                <div class="content-card fade-in-up delay-2 pb-2">
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card - VIEW ONLY) -->
                        @if($materiSosialBudaya && $materiSosialBudaya->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            ...
                            @foreach($materiSosialBudaya as $item)
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card - VIEW ONLY) -->
                        @if($materiPermasalahan && $materiPermasalahan->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="mb-2">
                            ...
                            @foreach($materiPermasalahan as $item)
                            <div class="nested-card">
                                <h5 class="nested-card-title"><i class="bi bi-bookmark-star"></i> {{ $item->judul }}</h5>
                                <div class="content-text text-dark prose fs-6">{!! $item->konten !!}</div>
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card - VIEW ONLY) -->
                        @if($materiPemberdayaan && $materiPemberdayaan->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="mb-2">
                            ...
                            @foreach($materiPemberdayaan as $item)
                            <div class="nested-card">
                                <h5 class="nested-card-title"><i class="bi bi-bookmark-star"></i> {{ $item->judul }}</h5>
                                <div class="content-text text-dark prose fs-6">{!! $item->konten !!}</div>
                    ...
                    <div class="topic-block">
                        ...
                        <!-- RUANG TAMBAHAN MATERI SISWA (Nested Card - VIEW ONLY) -->
                        @if($materiKomunitas && $materiKomunitas->count() > 0)
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="mb-2">
                            ...
                            @foreach($materiKomunitas as $item)
                            <div class="nested-card">
                                <h5 class="nested-card-title"><i class="bi bi-bookmark-star"></i> {{ $item->judul }}</h5>
                                <div class="content-text text-dark prose fs-6">{!! $item->konten !!}</div>

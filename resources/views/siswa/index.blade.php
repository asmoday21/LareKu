        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col items-center text-center">
                ...
                {{-- <div class="mb-6 floating">
                    <div class="relative">
                        <div class="w-24 h-24 rounded-full gradient-warning flex items-center justify-center mx-auto shadow-2xl border-4 border-white/20 status-indicator">
    ...
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8 flex-grow -mt-4">
        ...
        <div class="content-section p-8 mb-8 minang-pattern">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Materi Card -->
                <a href="{{ route('siswa.materi.index')}}" class="block menu-item group" data-aos="fade-up" data-aos-delay="100">
